...
int main(int argc, char *argv[]) {
    ...
    int itop, ibot, jpbcstart, jpbcstop, perc;
    double r;
    ...
    while (step <= maxstep) {
        ...
        /*
         *  Map is only periodic in the central two-thirds of the domain
         *  so reset the top and bottom extremes to zero. It may seem
